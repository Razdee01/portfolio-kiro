        ...
        <RevealOnScroll direction="up" delay={0.1}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Get to know the person behind the code - my journey, interests,
              and what drives my passion for creating digital experiences.
            </p>
          </div>
        </RevealOnScroll>
          ...
          <div className="space-y-8">
            ...
            <RevealOnScroll direction="right" delay={0.3}>
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  I started my programming journey because I was fascinated by
                  how the web works. The idea that code could create interactive
                  experiences and solve real problems captivated me from the
                  beginning. I've spent my time mastering JavaScript and React
                  to build projects that solve real-world problems, constantly
                  learning and growing with each new challenge I encounter.
                </p>
              </div>
            </RevealOnScroll>
            ...
            <RevealOnScroll direction="right" delay={0.4}>
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  I love building responsive UIs and working on the logic that
                  makes websites interactive. There's something incredibly
                  satisfying about crafting user interfaces that not only look
                  great but also provide seamless, intuitive experiences. My
                  passion lies in:
                </p>
            ...
            <RevealOnScroll direction="right" delay={0.5}>
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  I am a big fan of playing cricket, which helps me stay active
                  and teaches me about teamwork. Cricket has taught me valuable
                  lessons about strategy, patience, and collaboration - skills
                  that translate perfectly into software development. Whether
                  I'm batting, bowling, or fielding, the sport keeps me
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        Playing cricket teaches me teamwork, strategy, and
                        perseverance - qualities I bring to every coding
                        project.
                      </p>
                    </div>
                  </div>
          ...
          <div className="mt-16 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Cricket is my passion! It keeps me active and teaches me
                  valuable teamwork skills that I apply in development.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg">
                <div
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  I love building interactive UIs with React - there's something
                  magical about bringing designs to life with code.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg">
                <div
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  I'm fascinated by how the web works and love solving complex
