            ...
            <div className="space-y-8">
              ...
              <address className="space-y-6 not-italic">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-center group">
                    ...
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider">{info.label}</p>
                      {info.link ? (
                        <a href={info.link} className="text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 font-semibold transition-colors">
                          {info.value}
                        </a>
                      ) : (
              ...
              <div className="pt-8 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex space-x-4">
                  {[
                    { name: 'Twitter', url: 'https://x.com/RahmanRazdee', icon: <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z" /> },
                    { name: 'GitHub', url: 'https://github.com/Razdee01', icon: <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 00-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0020 4.77 5.07 5.07 0 0019.91 1S18.73.65 16 2.48a13.38 13.38 0 00-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 005 4.77a5.44 5.44 0 00-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 009 18.13V22" /> },
                    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/walid-rahman-rajdee-029b08264', icon: <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 2a2 2 0 11-2 2 2 2 0 012-2" /> },
                    { 
                      name: 'WhatsApp', 
          ...
          <RevealOnScroll direction="right" delay={0.2}>
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-gray-800">
              ...
              <div className="space-y-4">
                ...
                {submitStatus === 'success' && <p className="text-green-500 text-center font-medium">Message sent! I'll get back to you soon.</p>}
              </div>
            </form>
          </RevealOnScroll>
        </div>
