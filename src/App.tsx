...
function AppContent() {
  ...
  return (
    ...
    */
    <div className="min-h-screen w-full max-w-full bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300 custom-scrollbar overflow-x-hidden">
      {/* Navigation */}
